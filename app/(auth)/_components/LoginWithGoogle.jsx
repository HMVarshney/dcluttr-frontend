...
function LoginWithGoogle() {
    ...
    return (
        <Button
            ...
            onClick={() => {
                window.open(
                    `${process.env.NEXT_PUBLIC_API_URL}oauth2/authorize/google?redirect_uri=${window.location.href}`,
                    "_self"
                );
            }}
        >
            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                ...
                />
                <path
                    d="M3.12747 6.12133L5.86539 8.12925C6.60622 6.29508 8.40039 5.00008 10.5 5.00008C11.7746 5.00008 12.9341 5.48091 13.8171 6.26633L16.1741 3.90925C14.6858 2.52216 12.695 1.66675 10.5 1.66675C7.29914 1.66675 4.52331 3.47383 3.12747 6.12133Z"
                    fill="#FF3D00"
                />
                <path
                    d="M10.5 18.3331C12.6525 18.3331 14.6084 17.5094 16.0871 16.1698L13.5079 13.9873C12.6432 14.645 11.5865 15.0007 10.5 14.9998C8.33252 14.9998 6.4921 13.6177 5.79877 11.689L3.08127 13.7827C4.46043 16.4815 7.26127 18.3331 10.5 18.3331Z"
                    fill="#4CAF50"
                />
                <path
