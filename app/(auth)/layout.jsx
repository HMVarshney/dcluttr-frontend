        ...
        <div className="col-span-5 bg-primary h-full text-white flex items-center justify-center">
          <div className="max-w-[426px] ">
            <h1 className="font-bold text-[40px] leading-[48px]">
              Take better decisions with a single source of truth
            </h1>
            <div className="flex flex-col gap-4 mt-12">
              {[
                ...
                <div className="flex items-center gap-2" key={ele}>
                  ...
                  <div className="text-base font-medium">{ele}</div>
                </div>
              ))}
            </div>
            <hr className="my-11 border-white/20" />
            <div className="text-base font-semibold text-white/50">Connect all your marketing channels</div>
            <Image
