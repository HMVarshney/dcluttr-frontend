    ...
    <div className="px-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="mt-8 mb-12">
        ...
        <p className="text-xs -mt-3 mb-8 text-[#031B15CC]">
          Use a name the describes the group or team or agency. It appears in notification, invoices, and other
          team-specific areas.
        </p>
        <InputText
          label="Owner Email"
        ...
        />
        <p className="text-xs -mt-3 mb-8 text-[#031B15CC]">
          Thus will be used for all organization releated communication including emergencies and mission-critical
          tasks.
        </p>
        <InputText
