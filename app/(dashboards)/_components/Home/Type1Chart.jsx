...
export default function Type1Chart({ isLoading = false, data, details, dragHandleProps = {} }) {
  return (
      ...
      {isLoading ? (
        ...
        <ResponsiveContainer width="100%" height={160}>
          ...
          >
            ...
            <XAxis
              dataKey={data.dataKeyXAxis ? (ele) => moment(ele["orders.created_at"]).format("D MMM YY") : null}
              axisLine={false}
              tickLine={false}
