...
export default function BrandDetails({ goNext }) {
  ...
  return (
    <section className="h-[calc(100vh-66px)] flex items-center justify-center">
      <form onSubmit={handleSubmit(onSubmit)} className="max-w-xl w-full">
        ...
        <p className="text-base mt-1.5">You’re just minutes away from transforming your data into profitable growth</p>
        ...
        <FormSubmitButtonWithIcon isLoading={loading} text="Continue" />
