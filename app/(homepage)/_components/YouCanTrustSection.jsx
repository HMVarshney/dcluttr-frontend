    ...
    return (
        <div className=' max-w-4xl mx-auto'>
            ...
            <div className='flex gap-8 my-10'>
                {/* card 1 */}
                <div className="w-full border rounded-lg bg-[#fafafb] hover:m-[-2px_2px_2px_-2px] transition-all duration-300 ease-in-out relative group">
                    <span className=' transition-all duration-300 ease-in-out absolute opacity-0 -top-10 -left-10 group-hover:opacity-100 group-hover:-top-14 group-hover:-left-14 '>
                ...
                {/* card 2 */}
                <div className="w-full border rounded-lg bg-[#fafafb] hover:m-[-2px_2px_2px_-2px] transition-all duration-300 ease-in-out relative group">
                    <span className=' transition-all duration-300 ease-in-out absolute opacity-0 -top-10 -right-10 group-hover:opacity-100 group-hover:-top-14 group-hover:-right-14 '>
                        <svg width="54" height="80" viewBox="0 0 54 80" fill="#027056" xmlns="http://www.w3.org/2000/svg">
