    ...
    return (
        <section className='my-24 lg:my-52 max-w-5xl mx-auto px-4 lg:px-0'>
            ...
            <div className='flex flex-col lg:flex-row gap-6 lg:gap-8 my-6 lg:my-10'>
                {/* card 1 */}
                <div className="w-full border rounded-md bg-[#fafafb] hover:m-[-2px_2px_2px_-2px] transition-all duration-300 ease-in-out relative group hover:shadow-lg">
                    ...
                    <div className='pb-16 px-8'>
                        ...
                        <div className='text-black text-xl lg:text-3xl font-extrabold my-2 lg:my-4'>
