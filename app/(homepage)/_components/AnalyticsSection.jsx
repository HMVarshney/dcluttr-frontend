...
export default function AnalyticsSection() {
    return (
        <section className='my-24 lg:my-52 mx-auto max-w-5xl px-4'>
            <div className='flex items-center justify-center gap-2 lg:gap-3 font-extrabold text-center text-3xl lg:text-5xl'>
                Stop relying on sheets<Image src={"/icons/sheets.svg"} alt="logo" width={100} height={100} className="w-6 lg:w-12 object-contain" />
            </div>
            <p className='text-center text-base lg:text-xl my-6'>
                A scalable and secure solution trusted by the world’s leading organizations.
            </p>

            <div className='flex flex-col lg:flex-row gap-8 my-10'>
                {/* card 1 */}
                <div className="w-full lg:w-7/12 border rounded-md bg-[#fafafb] hover:m-[-2px_2px_2px_-2px] transition-all duration-300 ease-in-out relative group">
                    ...
                    <div className='pb-16 px-8 lg:w-2/3'>
                        <div className='text-black text-3xl font-extrabold my-4'>
                            Tailor the team’s experience
                        </div>
                        <div className='text-black text-base font-medium'>
                            Set the standard for how your team work with a customized landing experience and templates for your workspace.
                        </div>
                    </div>
                </div>

                {/* card 2 */}
                <div className="w-full lg:w-5/12 border rounded-md bg-[#fafafb] hover:m-[-2px_2px_2px_-2px] transition-all duration-300 ease-in-out relative group">
                    ...
                    <div className='pb-16 px-8'>
                        ...
                        <div className='text-black text-base font-medium'>
                            Control access and permissions to who can see what at the workspace, folder, and project level.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='flex flex-col lg:flex-row gap-8 my-10'>
                ...
                <div className="w-full lg:w-5/12 border rounded-md bg-[#fafafb] hover:m-[-2px_2px_2px_-2px] transition-all duration-300 ease-in-out relative group">
                    ...
                    <div className='pb-16 px-8'>
                        ...
                        <div className='text-black text-base font-medium'>
                            Understand how your team engages with customer insights and improve customer-centricity over time.
                        </div>
                    </div>
                </div>
                {/* card 4 */}
