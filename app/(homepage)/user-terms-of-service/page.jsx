...
export default function page() {
    return (
        <main className="h-full my-16 mx-auto max-w-5xl px-4">
            ...
            <p className='my-3'>
                Our Privacy Policystates how we collect and use personal information relating to your use of the Services.
            </p>
            <h3 className='font-extrabold text-2xl my-4'>
                10. Indemnities
            </h3>
            ...
            <p className='my-3'>
                ...
                12.9 Contact. For questions and notices, please email legal@dovetailapp.com.
            </p>
        </main>
    )
}
