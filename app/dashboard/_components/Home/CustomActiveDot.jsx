...
const CustomActiveDot = (props) => {
    ...
    return (
        <svg
            ...
            <circle cx="12" cy="12" r="12" fill={fill} fillOpacity="0.1" />
            <circle cx="12.0003" cy="11.9998" r="9.33333" fill={fill} fillOpacity="0.3" />
            <g filter="url(#filter0_d_588_518)">
                <circle cx="12.0003" cy="11.9998" r="5.33333" fill={fill} />
