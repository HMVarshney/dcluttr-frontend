        ...
        const res = await api
            .load({
                ...
                "dimensions": [
                    ...
                    "google_ads.name",
                    "google_ads_stream.resource_name"
                ],
                "timeDimensions": [
                    {
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(getCampaignDataGoogle.fulfilled, (state, action) => {
                ...
                state.campaignError = null;
                state.campaignData = action.payload?.results?.[0]?.data;
            })
            ...
            .addCase(getAdSetsGoogle.fulfilled, (state, action) => {
                ...
                state.adSetsError = null;
                state.adSetsData = action.payload?.data?.results?.[0]?.data;
            ...
            .addCase(getAdsGoogle.fulfilled, (state, action) => {
                ...
                state.adsError = null;
                state.adsData = action.payload?.data?.results?.[0]?.data;
