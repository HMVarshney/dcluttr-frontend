...
export const getCampaignDataGoogle = createAsyncThunk(
  "googleAds/getCampaignDataGoogle",
...
export const getBiddingStrategyGoogle = createAsyncThunk(
  "googleAds/getBiddingStrategyGoogle",
  async (_, { rejectWithValue }) => {
    try {
      const api = cubeJsApi();
      const res = await api.load({
