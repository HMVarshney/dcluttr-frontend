...
export const getCampaignData = createAsyncThunk('googleAds/getCampaignData', async (_, { rejectWithValue }) => {
    try {
...
export const getAdSets = createAsyncThunk('googleAds/getAdSets', async (_, { rejectWithValue }) => {
    try {
        const res = await cubeJsInterceptorInstance
            .load({
                "measures": [
...
// Thunk to handle Ads 
export const getAds = createAsyncThunk('googleAds/getAds', async (_, { rejectWithValue }) => {
    try {
        const res = await cubeJsInterceptorInstance
            .load({
                "measures": [
...
export const getBiddingStrategy = createAsyncThunk('googleAds/getBiddingStrategy', async (_, { rejectWithValue }) => {
    try {
        const res = await cubeJsInterceptorInstance
            .load({
                "measures": [
...
export const getAdsType = createAsyncThunk('googleAds/getAdsType', async (_, { rejectWithValue }) => {
    try {
        const res = await cubeJsInterceptorInstance
            .load({
                "measures": [
...
const googleAdsSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            //getAdsType
            .addCase(getAdsType.pending, (state) => {
                state.adsType.loading = true;
                state.adsType.error = null;
            })
            .addCase(getAdsType.fulfilled, (state, action) => {
                state.adsType.loading = false;
                state.adsType.error = null;
                state.adsType.data = action.payload;
            })
            .addCase(getAdsType.rejected, (state, action) => {
                state.adsType.loading = false;
